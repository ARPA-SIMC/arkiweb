#ifndef ARKIWEB_WOBBLE_TESTS_H
#define ARKIWEB_WOBBLE_TESTS_H
 ...
 */
extern const arkiweb::wobble::tests::LocationInfo arkiweb_wobble_test_location_info;
 ...
 */
#define ARKIWEB_WOBBLE_TEST_INFO(name) \
    wobble::tests::LocationInfo arkiweb_wobble_test_location_info; \
    wobble::tests::LocationInfo& name = arkiweb_wobble_test_location_info
...
#define wassert(...) \
    do { try { \
        ...
        e.add_stack_info(__FILE__, __LINE__, #__VA_ARGS__, arkiweb_wobble_test_location_info); \
        throw; \
    } catch (std::exception& e) { \
        throw wobble::tests::TestFailed(e, __FILE__, __LINE__, #__VA_ARGS__, arkiweb_wobble_test_location_info); \
    } } while(0)
...
#define wcallchecked(func) \
    [&]() { try { \
        ...
        e.add_stack_info(__FILE__, __LINE__, #func, arkiweb_wobble_test_location_info); \
        throw; \
    } catch (std::exception& e) { \
        throw wobble::tests::TestFailed(e, __FILE__, __LINE__, #func, arkiweb_wobble_test_location_info); \
    } }()
